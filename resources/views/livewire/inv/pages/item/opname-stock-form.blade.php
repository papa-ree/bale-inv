...
<div>
    ...
    <x-bale.page-container>
        ...
        <form wire:submit='store' class="mt-8">
            ...
            <div class="mb-4">
                <x-bale.input type="text" label="Note" wire:model="note" autocomplete="off" name="note" />
                <x-input-error for="note" />
            </div>

            <x-bale.modal-action>
                <x-bale.button label="Submit" type="submit" wire:dirty.attr="disabled" wire:target='store' />
            </x-bale.modal-action>
        </form>
    </x-bale.page-container>
</div>
